  ...
  return (
    <Container className="mt-3">
      <Container className="small-container">
        ...
        <h1 className="my-3 bold italic">Terms and condations</h1>
        <p className="bold">
        ...
        <ol>
          ...
          <li>Store credit</li>
          <li>Promotions</li>
          <li> Rules about your content</li>
          <li> Our rights to use your content</li>
          <li> Use of website and mobile applications</li>
          <li> Copyright and trademarks</li>
          <li> Data privacy</li>
          <li> Due diligence and audit rights</li>
          <li>Amazona's role as a marketplace</li>
          ...
          <li> Our company details and notices</li>
        </ol>
        <ol>
          <li>
            <p>Introduction</p>
            <ol>
              <li>
                ”Amazona” is the trading name for the Amazona group companies
                listed at Appendix 1. Each Amazona group company (“Amazona” or
                “we”) operates an e-commerce platform consisting of a website
                and mobile application (“marketplace”), together with supporting
                IT, logistics and payment infrastructure, for the sale and
                purchase of consumer products and services (“products”) in its
                allocated territory as defined at Appendix 1 (“territory”).{" "}
              </li>
              <li>
                {" "}
                These general terms and conditions shall apply to buyers and
              ...
              <li>
                ...
                conditions or any part of these general terms and conditions,
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    ...
                    entity that operates that business or organizational
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                You may not register with our marketplace if you are under 18
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    ...
                    provided at section 26) if you become aware of any
                    disclosure of your password; and
                  </li>
                  <li>
                    {" "}
                    be responsible for any activity on our marketplace arising
                    out of any failure to keep your password confidential, and
                    you acknowledge that you may be held liable for any losses
              ...
              <li>
                ...
                third party to manage your account on your behalf this shall be
                at your own risk.
              </li>
              <li>
                {" "}
                We may suspend or cancel your account, and/or edit your account
                details, at any time in our sole discretion and without notice
                or explanation, providing that if we cancel any products or
                services you have paid for but not received, and you have not
                breached these general terms and conditions, we will refund you
                in respect of the same. See section 4.2 below for further
            ...
            <ol>
              <li>
                ...
                <ol>
                  <li>
                    {" "}
                    the marketplace provides an online location for sellers to
                    sell and buyers to purchase products;
                  </li>
                  <li>
                    {" "}
                    we shall accept binding sales, on behalf of sellers, but
                    (unless Amazona is indicated as the seller) Amazona is not a
                    party to the transaction between the seller and the buyer;
                    and
                  </li>
                  <li>
                    {" "}
                    a contract for the sale and purchase of a product or
                    products will come into force between the buyer and seller,
                    and accordingly you commit to buying or selling the relevant
                    product or products, upon the buyer's confirmation of
              ...
              <li>
                {" "}
                Subject to these general terms and conditions, the seller's
                terms of business shall govern the contract for sale and
                purchase between the buyer and the seller. Notwithstanding this,
                the following provisions will be incorporated into the contract
                of sale and purchase between the buyer and the seller:
                <ol>
                  <li>
                    {" "}
                    the price for a product will be as stated in the relevant
                    product listing;
                  </li>
                  <li>
                    {" "}
                    the price for the product must include all taxes and comply
                    with applicable laws in force from time to time;
                  </li>
                  <li>
                    {" "}
                    delivery charges, packaging charges, handling charges,
                    administrative charges, insurance costs, other ancillary
                    costs and charges, where applicable, will only be payable by
                    the buyer if this is expressly and clearly stated in the
                    product listing; and delivery of digital products may be
                    made electronically;
                  </li>
                  <li>
                    {" "}
                    products must be of satisfactory quality, fit and safe for
                    any purpose specified in, and conform in all material
                    respects to, the product listing and any other description
                    of the products supplied or made available by the seller to
                    the buyer; and
                  </li>
                  <li>
                    {" "}
                    in respect of physical products sold, the seller warrants
                    that the seller has good title to, and is the sole legal and
                    beneficial owner of, the products and/or has the right to
                    supply the products pursuant to this agreement, and that the
                    products are not subject to any third party rights or
                    restrictions including in respect of third party
                    intellectual property rights and/or any criminal, insolvency
                    or tax investigation or proceedings; and in respect of
                    digital products the seller warrants that the seller has the
                    right to supply the digital products to the buyer.
                  </li>
                  <li>
                    {" "}
                    The Seller warrants that, where a product sold has such
                    terms, the Seller will provide detailed disclosure of the
                    product terms and conditions, any applicable warranty, and
                    other terms necessary to inform the buyer on the product and
                    its usage in the specification section provided on each
                    product page.
                  </li>
                </ol>
              </li>
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                Returns of products by buyers and acceptance of returned
                products by sellers shall be managed by us in accordance with
                the returns page on the marketplace, as may be amended from time
                to time. Acceptance of returns shall be in our discretion,
                subject to compliance with applicable laws of the territory.
              </li>
              <li>
                {" "}
                Refunds in respect of returned products shall be managed in
                accordance with the refunds page on the marketplace, as may be
                amended from time to time. Our rules on refunds shall be
                exercised in our discretion, subject to applicable laws of the
                territory. We may offer refunds, in our discretion:
                <ol>
                  <li> in respect of the product price;</li>
                  <li>
                    {" "}
                    in respect of local and/or international shipping fees (as
                    stated on the refunds page); and
                  </li>
                  <li>
                    {" "}
                    by way of store credits, vouchers, mobile money transfer,
                    bank transfers or such other methods as we may determine
                    from time to time.
                  </li>
                </ol>
              </li>
              <li>
                ...
                Amazona, acting for and on behalf of the seller. Notwithstanding
                paragraphs 4.1 and 4.2 above, in respect of digital products or
                services and fresh food, Amazona shall issue refunds in respect
                of failures in delivery only. Refunds of payment for such
                products for any other reasons shall be subject to the seller's
                terms and conditions of sale.
              </li>
              <li>
                {" "}
                Changes to our returns page or refunds page shall be effective
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                Store credits may be earned and managed in accordance with the
                Amazona Store Credit Terms and Conditions, as may be amended
                from time to time. Amazona reserves the right to cancel or
                withdraw Amazona store credit rewards for any reason in its
                discretion, including if we suspect fraud or foul play. You can
                view the Amazona Store Credit terms and conditions and
                information about your Amazona store credit account on our
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                Promotions and competitions run by Amazona and/or other
                promoters shall be managed in accordance with the Promotions
                Terms and Conditions, where applicable. You can view Promotions
                Terms and Conditions where they apply on our website or mobile
                application.
              </li>
            </ol>
          </li>
          <li>
            <p>Rules about your content</p>
            <ol>
              <li>
                {" "}
              ...
              <li>
                {" "}
                Your content must be appropriate, civil and tasteful, and accord
                with generally accepted standards of etiquette and behaviour on
                the internet, and must not:
                <ol>
                  <li>
                    {" "}
                    be offensive, obscene, indecent, pornographic, lewd,
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    {" "}
                    any right of confidence, right of privacy or right under
              ...
              <li>
                {" "}
                The review function on the marketplace may be used to facilitate
              ...
              <li>
                {" "}
                You must not interfere with a transaction by: (i) contacting
              ...
              <li>
                ...
                to remove any content in our discretion for any reason
                whatsoever.
              </li>
              <li>
                {" "}
          ...
          <li>
            <p>Our rights to use your content</p>
            <ol>
              <li>
                {" "}
              ...
              <li>
                ...
                the rights licensed under section 9.1.
              </li>
              <li>
                {" "}
              ...
              <li>
                {" "}
                Without prejudice to our other rights under these general terms
                and conditions, if you breach our rules on content in any way,
                or if we reasonably suspect that you have breached our rules on
          ...
          <li>
            <p> Use of website and mobile applications</p>
            <ol>
              <li>
                {" "}
                In this section 10 words “marketplace” and "website” shall be
                used interchangeably to refer to Amazona's websites and mobile
                applications.
              </li>
              <li>
                {" "}
                ...
                <ol>
                  ...
                  <li>
                    {" "}
                    stream audio and video files from our website using the
              ...
              <li>
                {" "}
                Except as expressly permitted by section 10.2 or the other
              ...
              <li>
                {" "}
                Notwithstanding section 10.6, you may forward links to products
              ...
              <li>
                ...
                <ol>
                  <li>
                    {" "}
                    use our website in any way or take any action that causes,
                  ...
                  <li>
                    {" "}
                    circumvent any authentication or security systems or
                  ...
                  <li>
                    {" "}
                    access or otherwise interact with our website using any
                  ...
                  <li>
                    {" "}
                    violate the directives set out in the robots.txt file for
                    our website;
                  </li>
                  <li>
                    {" "}
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                {" "}
                Amazona's logos and our other registered and unregistered
              ...
              <li>
                ...
                grant any license to exercise such rights.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol>
              <li>
                ...
                with the terms of Amazona's Privacy Notice and Cookie Notice.
              </li>
              <li>
                {" "}
                Amazona shall process all personal data obtained through the
              ...
              <li>
                ...
                of their personal data and Amazona shall bear no liability to
                buyers in respect of any misuse by sellers of their personal
                data.
              </li>
            </ol>
          </li>
          <li>
            <p> Due diligence and audit rights</p>
            <ol>
              <li>
                {" "}
                We operate an anti-fraud and anti-money laundering compliance
                program and reserve the right to perform due diligence checks on
                all users of the marketplace.
              </li>
              <li>
                {" "}
                You agree to provide to us all such information, documentation
                and access to your business premises as we may require:
                <ol>
                  <li>
                    {" "}
                    in order to verify your adherence to, and performance of,
                    your obligations under these terms and conditions;
                  </li>
                  <li>
                    {" "}
                    for the purpose of disclosures pursuant to a valid order by
          ...
          <li>
            <p> Amazona's role as a marketplace</p>
            <ol>
              <li>
                {" "}
                ...
                <ol>
                  <li>
                    {" "}
                    Amazona facilitates a marketplace for buyers and third party
                    sellers or Amazona, where Amazona is the seller of a
                    product;
                  </li>
                  <li>
                    {" "}
                    the relevant seller of the product (whether Amazona is the
                    seller or whether it is a third party seller) shall at all
                    times remain exclusively liable for the products they sell
                    on the marketplace; and
                  </li>
                  <li>
                    {" "}
                    in the event that there is an issue arising from the
                    purchase of a product on the marketplace, the buyer should
                    seek recourse from the relevant seller of the product by
                    following the process set out in Amazona's Dispute
                    Resolution Policy[a].
                  </li>
                </ol>
              </li>
              <li>
                {" "}
                We commit to ensure that Amazona, or third party sellers, as
                applicable, submit information relating to their products on the
                marketplace that is complete, accurate and up to date and
                pursuant thereto:
                <ol>
                  <li>
                    {" "}
                    the relevant seller warrants and represents the completeness
                    and accuracy of their information published on our
                    marketplace relating to their products;
                  </li>
                  <li>
                    {" "}
                    the relevant seller warrants and represents that the
                    material on the marketplace is up to date; and
                  </li>
                  <li>
                    {" "}
                    if a buyer has a complaint relating to the accuracy or
                    completeness of the product information received from a
                    seller (including where Amazona is the seller), the buyer
                    can seek recourse from the relevant seller by following the
                    process set out in the Amazona Dispute Resolution Policy[b].
                  </li>
                </ol>
              </li>
              <li>
                {" "}
                We do not warrant or represent that the marketplace will operate
                without fault; or that the marketplace or any service on the
                marketplace will remain available during the occurrence of
                events beyond Amazona's control (force majeure events) which
                include but are not limited to; flood, drought, earthquake or
                other natural disasters; hacking, viruses, malware or other
              ...
              <li>
                ...
                services, or if we stop publishing the marketplace. This is
                without prejudice to your rights in respect of any unfulfilled
                orders or other existing liabilities of Amazona.
              </li>
              <li>
                {" "}
                If we discontinue or alter any or all of our marketplace in
                circumstances not relating to force majeure, we will provide
                prior notice to the buyers and sellers of not less than fifteen
                (15) days with clear guidance on the way forward for the pending
                transactions or other existing liabilities of Amazona.
              </li>
              <li>
                {" "}
              ...
              <li>
                ...
                section 15.1 below, we exclude all representations and
                warranties relating to the subject matter of these general terms
                and conditions, our marketplace and the use of our marketplace.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                section 15 and elsewhere in these general terms and conditions:
                <ol>
                  ...
                  <li>
                    ...
                    general terms and conditions, including liabilities arising
              ...
              <li>
                ...
                provide services to you under these general terms and conditions
                shall not exceed the total amount paid and payable to us under
                the contract. Each separate transaction on the marketplace shall
                constitute a separate contract for the purpose of this section
                15.4.
              </li>
              <li>
                {" "}
                Notwithstanding section 15.4 above, we will not be liable to you
                ...
                <ol>
                  ...
                  <li>
                    {" "}
                    any business losses, including (without limitation) loss of
              ...
              <li>
                ...
                suffer in connection with the marketplace or these general terms
                and conditions (this will not limit or exclude the liability of
                the limited liability entity itself for the acts and omissions
              ...
              <li>
                ...
                <ol>
                  <li>
                    ...
                    indirectly out of your use of our marketplace or any breach
                    by you of any provision of these general terms and
                    conditions or the Amazona codes, policies or guidelines; and
                  </li>
                  <li>
                    {" "}
                    ...
                    to pay, withhold, declare or register to pay any VAT or
          ...
          <li>
            <p> Breaches of these general terms and conditions</p>
            <ol>
              <li>
                {" "}
                If we permit the registration of an account on our marketplace
                it will remain open indefinitely, subject to these general terms
                and conditions.
              </li>
              <li>
                {" "}
                ...
                and conditions or any Amazona codes, policies or guidelines in
                any way we may:
                <ol>
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                These general terms and conditions and the Amazona codes,
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                Should these general terms and conditions, the seller terms and
                conditions, and the Amazona codes, policies and guidelines be in
                conflict, these terms and conditions, the seller terms and
                conditions and the Amazona codes, policies and guidelines shall
                prevail in the order here stated.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol>
              <li>
                ...
                terms and conditions, and the Amazona codes, policies and
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                No waiver of any breach of any provision of these general terms
                and conditions shall be construed as a further or continuing
                waiver of any other breach of that provision or any breach of
                any other provision of these general terms and conditions.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol>
              ...
              <li>
                {" "}
                If any unlawful and/or unenforceable provision of these general
          ...
          <li>
            ...
            <ol>
              <li>
                {" "}
                A contract under these general terms and conditions is for our
              ...
              <li>
                ...
                general terms and conditions is not subject to the consent of
                any third party.
              </li>
            </ol>
          </li>
          ...
          <li>
            <p> Our company details and notices</p>
            <ol>
              <li>
                {" "}
                You can contact us by using the contact details listed in
                Appendix 1.
              </li>
              <li>
                {" "}
                You may contact our sellers for after-sales queries, including
                any disputes, by requesting their contact details, including the
                full legal name of the Seller and where applicable the shop
                name, from Amazona in accordance with the Dispute Resolution
                Policy[c], pursuant to which Amazona shall be obliged to ensure
                that the seller is identifiable and clearly linked to the
